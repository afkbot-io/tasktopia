...
- единая навигация `Планета → Страна → Город`: доступные страны образуют seed-материки, а между странами и городами проходят воздушные маршруты;
- страна открывается компактной WebGL-сценой, а выбранный город приходит одним атомарным scene-запросом; перемещение внутри города не запускает сетевую чанковую загрузку;
- города и районы получают разные планировки, дороги, мосты, тротуары и общественные пространства;
- новые задачи получают здания из активного V5-каталога: малоэтажные и среднеэтажные ЖК либо среднеэтажные и высотные новостройки; прежние частные дома больше не участвуют в размещении;
...
- каждый город получает крупный аэропорт, а самолёты связывают города и страны различными маршрутами;
...
| Каталог | Количество |
|---|---:|
| Семейства зданий | 167 |
| Строительные стадии зданий | 835 |
| Props и городской декор | 288 |
| Модели транспорта | 8 |
| Terrain families | 12 |
| Все runtime PNG | 1 318 |
