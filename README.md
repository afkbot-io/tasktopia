...
При регистрации веб-интерфейс атомарно создаёт аккаунт, первую страну и первый город. Страна содержит города, города — районы, а каждая задача отображается отдельным зданием. Дальнейшее управление городами, районами и задачами выполняется через MCP/API.
