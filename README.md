...
Управление городами, районами и задачами выполняется через MCP/API. Веб-интерфейс показывает карту и план, карточки задач, страны, палату, аккаунт и персональный MCP-доступ.
