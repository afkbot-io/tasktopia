...
![Живой город Tasktopia](screenshots/tasktopia-showcase.png)
...
В графическом паке более 1 200 проверенных PNG: 193 семейства зданий, 965 строительных стадий и 173 элемента транспорта, природы и городского декора.
...
assets/pixel-city-pack-v4/ исходники и спецификация графического пака
public/game-assets/v4/     готовые игровые ресурсы
