...
- каталог содержит 36 компактных семейств зданий (27 жилых, восемь служб и торговый центр), включая длинные горизонтальные и вертикальные корпуса, Г- и П-образные дома; парки, вода и парковка занимают собственные task-слоты. Большой прежний каталог удалён;
- уникальные типы выдаются по одному на город и распределяются по кварталам; из [перечня 20 типов](docs/art/CITY-LANDMARKS-2026-09-09.md) пока подключён торговый центр, остальные ожидают завершения графики;
...
|---|---:|
| Семейства зданий | 36 |
| Строительные стадии зданий | 180 |
| Props и городской декор | 110 |
| Модели транспорта | 8 |
