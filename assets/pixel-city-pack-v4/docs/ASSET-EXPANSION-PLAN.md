...
**Транспорт и остановки:** восемь самостоятельных моделей машин в двух нарисованных направлениях; три семейства остановок (`bus-stop`, `bus-stop-modern`, `bus-stop-green`) с horizontal/vertical вариантами.
