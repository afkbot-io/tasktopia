...
видов животных. Инциденты используют три структурно разные пожарные машины
`48×16`/`46×14` (автоцистерна, спасательная и автолестница) в той же near-top
проекции, что легковые: наклонное лобовое стекло, сужающийся капот, видимая
верхняя и ближняя боковая плоскости, ступенчатый контур и округлые колёса; и четыре кадра огня
