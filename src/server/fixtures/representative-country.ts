...
const TASKS_BY_ARCHETYPE: Record<DistrictArchetype, Omit<TaskTemplate, "estimate">[]> = {
  ...
  PRIVATE: [
    { title: "Построить небольшой семейный дом", description: "Компактное малоэтажное жильё." },
    { title: "Построить частный коттедж", description: "Отдельный дом с небольшим двором." },
    { title: "Построить городской таунхаус", description: "Плотный ряд малоэтажных домов." },
    { title: "Построить кирпичный дуплекс", description: "Дом на две семьи." },
    { title: "Открыть угловое кафе", description: "Небольшой сервис для жителей района." },
    { title: "Построить садовую виллу", description: "Частный дом с зелёным участком." },
    { title: "Построить ряд малоэтажных домов", description: "Единый фронт частной улицы." },
    ...
    { title: "Построить большую усадебную группу", description: "Крупная задача частного района." },
  ],
  COMMERCIAL: [
  ...
  MIXED_URBAN: [
    ...
    { title: "Построить городской дуплекс", description: "Переход от малоэтажной к плотной застройке." },
...
export const REPRESENTATIVE_CITIES: CityTemplate[] = [
  ...
  },
  {
    ...
    description: "Небольшой зелёный город частных домов, парков и локальных сервисов.",
