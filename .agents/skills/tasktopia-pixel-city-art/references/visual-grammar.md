...
- Emergency road vehicles are measured against the normal car family. A fire engine is `40×16 px` with a `38×12 px` opaque body — visibly longer and taller than a `24×16 px` passenger car, but not a building-sized prop. It keeps the same horizontal frontal-top roof visibility and road baseline as cars; ladders and roof equipment stay within the authored vehicle silhouette.
