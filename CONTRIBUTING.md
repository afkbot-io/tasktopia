...
## Продуктовая граница интерфейса

Следуйте [правилам интерфейса и MCP](docs/PRODUCT-UI-RULES.md): новые элементы
карточек и отчётов предназначены для чтения и навигации. Изменение задач выполняется
через MCP; не добавляйте кнопки начала, назначения или завершения работы в UI.
