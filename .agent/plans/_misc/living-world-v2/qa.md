...
8. Добавить к одной задаче 1, 3, 5 и 6 активных дефектов: число шлейфов растёт 1 → 2 → 3, а огонь и струя появляются только с шестого; исправление до пяти немедленно убирает огонь.
