...
- [completed] Add topology invariants and overview payload regression tests. Verified: 25 targeted tests.
- [completed] Implement compact varied paths and LOD filtering. Verified: 89 unit/integration tests.
