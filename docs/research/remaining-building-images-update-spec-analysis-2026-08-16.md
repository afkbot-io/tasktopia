...
Архивное исследование, не действующий контракт генерации. С 2026-09-05 старый
каталог и инструменты ниже заменены [компактным cutover](../COMPACT-BLOCK-CUTOVER.md)
и [новым art-контрактом](../art/COMPACT-BUILDING-ART-CONTRACT.md). Исторические
числа и ссылки на удалённые файлы сохранены как свидетельство прежнего состояния.
