...
6. Открыть горящее высокое здание: пожарная имеет автобусный canvas `56×24`,
   ...
   боковая плоскости. Машина не выглядит пикапом или прямоугольным примитивом. Струя
...
3. Проверьте пожарную машину у бордюра при native `1x`: canvas `56×24`, кузов `54×22`; читаются высокая кабина, два крупных колеса и назначение модели — цистерна, спасательные шкафы или лестница. Габарит совпадает с автобусом `56×24` и заметно больше легковой `24×16`.
