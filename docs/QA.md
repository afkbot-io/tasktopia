...
6. Открыть горящее высокое здание: пожарная имеет canvas `48×16`, равна двум
   легковым по длине, ниже автобуса и стоит целиком справа от фасада. У кабины
   видны ступенчатая крыша, боковое и наклонное лобовое стекло, сужающийся
   капот, верхняя и ближняя боковая плоскости; два колеса округлые и стоят на
   той же baseline, что колёса легковой. Кузов не выглядит прямоугольной
   коробкой. Струя
...
3. Проверьте пожарную машину у бордюра при native `1x`: canvas `48×16`, кузов `46×14`; читаются кабина, два колеса и назначение модели — цистерна, спасательные шкафы или лестница. Машина длиннее легковой `24×16`, но меньше автобуса `56×24`.
