...
8. В шапке видна кнопка `Карта`, отдельной кнопки `План` и нижних help-плашек нет; `План страны` доступен из меню названия страны. Кнопка аккаунта квадратная, высота шапки на desktop равна `52 px`.
